...
const Promo = (props) => {
  return (
    <section className="p-4 lg:p-8 dark:bg-gray-800 dark:text-gray-100 rounded-md bg-black text-stone-300">
	<div className="container mx-auto space-y-12">
		<div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row">
			<img src={props.image} alt="cask" className="h-80 dark:bg-gray-500"  />
